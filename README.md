...
------------------------------------------------------------------------
 ...
 1> go get github.com/sagar-sinha/aporeto/samples/problemX (replace X by 2 or 3)
 2> $GOPATH/bin/problemX (The command above downloads the binary into your bin Go workspace's bin folder, find and run it )
